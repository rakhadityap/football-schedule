...
class EventDetailPresenterTest {
    ...
    @Mock
    private lateinit var call: Call<EventDetailResponse>
    @Mock
    private lateinit var res: Response<EventDetailResponse>
    @Captor
    private lateinit var captor: ArgumentCaptor<Callback<EventDetailResponse>>
    ...
    fun testGetEventDetail() {
        ...
        Mockito.verify(view).showDetail(res.body()?.events?.get(0))
    }
}